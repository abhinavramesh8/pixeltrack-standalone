...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  void SiPixelGainCalibrationForHLTESProducer::produce(edm::EventSetup& eventSetup) {
    ...
    auto ped_d{cms::alpakatools::make_device_unique<SiPixelGainForHLTonGPU::DecodingStructure>(
      numDecodingStructures, Queue{device})};
    ...
    auto rangeAndCols_d{cms::alpakatools::make_device_unique<SiPixelGainForHLTonGPU::RangeAndCols>(
      2000u, Queue{device})};
    auto rangeAndCols_d_view = cms::alpakatools::createDeviceView<SiPixelGainForHLTonGPU::RangeAndCols>(
      rangeAndCols_d.get(), 2000u);
    ...
    auto fields_d{cms::alpakatools::make_device_unique<SiPixelGainForHLTonGPU::Fields>(1u, Queue{device})};
    auto fields_d_view = cms::alpakatools::createDeviceView<SiPixelGainForHLTonGPU::Fields>(
      fields_d.get(), 1u);
