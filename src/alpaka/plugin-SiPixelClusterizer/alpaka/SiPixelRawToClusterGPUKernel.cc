...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  namespace pixelgpudetails {
    ...
    SiPixelRawToClusterGPUKernel::WordFedAppender::WordFedAppender()
        : word_{cms::alpakatools::make_host_unique<unsigned int>(MAX_FED_WORDS, Queue{device})},
          fedId_{cms::alpakatools::make_host_unique<unsigned char>(MAX_FED_WORDS, Queue{device})} {}
  ...
  namespace pixelgpudetails {
    ...
    void SiPixelRawToClusterGPUKernel::makeClustersAsync(bool isRun2,
      ...
      if (wordCounter)  // protect in case of empty event....
      {
        ...
        auto word_d = cms::alpakatools::make_device_unique<uint32_t>(wordCounter, Queue{device});
        ...
        auto fedId_d = cms::alpakatools::make_device_unique<uint8_t>(wordCounter / 2, Queue{device});
...

      {
        ...
        const WorkDiv1 &workDivOneBlock = cms::alpakatools::make_workdiv(Vec1::all(1u), Vec1::all(1024u));
        ...
        // slice on host
        auto nModules_Clusters_1_h{cms::alpakatools::make_host_unique<uint32_t>(1u, Queue{device})};
