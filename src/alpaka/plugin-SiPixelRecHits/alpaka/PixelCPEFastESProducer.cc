...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  void PixelCPEFastESProducer::produce(edm::EventSetup &eventSetup) {
    ...
    auto commonParams_d {cms::alpakatools::make_device_unique<pixelCPEforGPU::CommonParams>(1u, queue)};
    ...
    auto detParams_d {cms::alpakatools::make_device_unique<pixelCPEforGPU::DetParams>(ndetParams, queue)};
    ...
    auto averageGeometry_d {cms::alpakatools::make_device_unique<pixelCPEforGPU::AverageGeometry>(1u, queue)};
    ...
    auto layerGeometry_d {cms::alpakatools::make_device_unique<pixelCPEforGPU::LayerGeometry>(1u, queue)};
    ...
    auto params_d {cms::alpakatools::make_device_unique<pixelCPEforGPU::ParamsOnGPU>(1u, queue)};
